...
const ClientContent = () => {
  ...
  const getPaste = async () => {
    const res = await fetchData(`api/paste/${params.get("id")}`, {});
    setPaste(res);
    setPageState(true);
  };
            ...
            <div className="border rounded-lg px-6 py-4 mb-4">
              ...
              <div className="mb-4">
                <div className="flex flex-row gap-4">
                  ...
                  <div className="flex flex-row gap-2 items-center">
                    <span className="text-gray-400">{paste.paste_stats?.clicks ? paste.paste_stats?.clicks : 0}</span>
                    ...
                    return (
                      <div className="border p-4 rounded-lg mb-2" key={comment.id}>
                        <div className="flex gap-2 items-center justify-between">
                          <h1 className="text-lg text-blue-500 hover:underline cursor-pointer">{comment.user.name}</h1>
